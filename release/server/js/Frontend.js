...
var com_tamina_cow4_ui_EndScreen = function(width,height) {
	createjs.Container.call(this);
	this._width = width;
	this._height = height;
...
com_tamina_cow4_ui_EndScreen.__name__ = ["com","tamina","cow4","ui","EndScreen"];
com_tamina_cow4_ui_EndScreen.__super__ = createjs.Container;
com_tamina_cow4_ui_EndScreen.prototype = $extend(createjs.Container.prototype,{
	setMessage: function(message) {
		this._messageText.text = message;
	}
	,__class__: com_tamina_cow4_ui_EndScreen
});
...
var com_tamina_cow4_ui_PlayerCellSprite = function(data) {
	...
	this._playerSprite = new com_tamina_cow4_ui_IASprite("images/ia_sprite.png");
...
com_tamina_cow4_ui_PlayerMapUI.prototype = $extend(com_tamina_cow4_ui_MapUI_$com_$tamina_$cow4_$ui_$PlayerCellSprite.prototype,{
	updateMap: function(ia,actions) {
		var _g2 = this;
		haxe_Log.trace("updateMap " + actions.length,{ fileName : "PlayerMapUI.hx", lineNumber : 40, className : "com.tamina.cow4.ui.PlayerMapUI", methodName : "updateMap"});
	...
	,parseAction: function(ia,action) {
		...
		case "fail":
			var fail = action;
			haxe_Log.trace(fail.message,{ fileName : "PlayerMapUI.hx", lineNumber : 64, className : "com.tamina.cow4.ui.PlayerMapUI", methodName : "parseAction"});
...
com_tamina_cow4_view_component_IAInfoComponent.__meta__ = { obj : { view : ["com/tamina/cow4/view/component/IAInfoComponent.html"]}, fields : { _logo : { skinpart : [""]}, _name : { skinpart : [""]}, _pm : { skinpart : [""]}, _potion : { skinpart : [""]}, _trap : { skinpart : [""]}, _parfum : { skinpart : [""]}}};
